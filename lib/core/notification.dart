...
class NotificationSetUp {
  ...
  Future<void> createOrderNotifications({String? title, String? body, Map<String, String>? payload}) async {
...
class NotificationController {
  ...
  static Future<void> onActionReceivedMethod(ReceivedNotification receivedNotification) async {
    ...
    if (receivedNotification.channelKey == 'high_importance_channel') {
      ...
      if (receivedNotification.payload != null && receivedNotification.payload!['route'] != null) {
